...
//function which displays menu items;
function displayMenuItems(menuItems) {
  ...
  //HTML generated for each menu item;
...
//to show all menu when page displayed;
...
categories.forEach((category) => {
  ...
  // buttons should be added to container: btnContainer
